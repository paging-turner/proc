...
set Raylib_Lib=libraries\raylib-5.5_win32_msvc16\lib\raylib.lib
...
cl %App_Source_File% %Base_Obj_File% /Fe%App_Exe_File% /MD %Raylib_Lib% %App_Windows_Libs% /link /NODEFAULTLIB:LIBCMT
